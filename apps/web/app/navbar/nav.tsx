...
export function CustomNavBar({ session, components, navData, final }: { session: Session | null, components: NavObjectType[], navData: any, final: object[] }) {
  return (
    <NavDemo components={components} navData={navData} final={final} />
  );
}
